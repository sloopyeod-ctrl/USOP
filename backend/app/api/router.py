...
from app.api.v1.decision_patterns import router as decision_pattern_router
from app.api.v1.decision_drafts import router as decision_draft_router
...
router.include_router(decision_pattern_router)
router.include_router(decision_draft_router)
