...
function buildGraph(data) {
  ...
  data.groups.forEach((group, index) => {
    ...
    graphEdges.push({
      ...
      animated:
        group.privilege_level === "Privileged",
  ...
  data.roles.forEach((role, index) => {
    ...
    graphEdges.push({
      ...
      target: role.role_id,
      animated:
        role.privilege_level === "Privileged",
      ...
      >
        <CardContent>
          ...
          >
            ...
            >
              <Chip
                label={`${graph.accounts.length} Accounts`}
                color="success"
              />

              <Chip
                label={`${graph.groups.length} Groups`}
                color="warning"
              />

              <Chip
                label={`${graph.roles.length} Roles`}
                color="secondary"
              />
            </Stack>
          </Stack>
